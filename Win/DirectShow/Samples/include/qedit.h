/*
 * QEdit.h is no longer available from Microsoft so we retain this verion. 
 *
 * Since dxtrans.h is also no longer available, it has been removed from this file and the following definitions
 * resolve compile errors that stem from the missing dxtrans.h file.
 *
 * This solution was taken from http://jaewon.mine.nu/jaewon/2009/06/17/a-workaround-for-a-missing-file-dxtrans-h-in-directx-sdk/
 */
...
#include "oaidl.h"
#include "ocidl.h"
//#include "dxtrans.h"		// dxtrans.h is no longer available from Microsoft
#include "amstream.h"
